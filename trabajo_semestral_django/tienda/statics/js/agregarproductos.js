function guardarAlmacenamientoLocal(llave, valor_a_guardar) {
  ...
  window.addEventListener("load", () => {
    ...
    for (let i = 0; i < productos.length; i++) {
      mostraProductos.innerHTML += `<div class="contenedorProductos"><img src="${productos[i].urlImagen}" class="foto"><div class="informacion"><p>${productos[i].nombre}</p><p class="precio"><span>Precio: $${productos[i].valor}</span><p> Stock: ${productos[i].existencia} Unidades</p></div></div>`
  }
  })
